...
def process_frame(frame_num:int, video_full_file_name:str, exercises_dict:dict, detector, predictor):
...
def get_video_points(progress_update, video_full_file_name, markup_full_file_name, points_full_file_name, predictor_full_file_name):
    ...
    with Pool() as pool:
        video_points = pool.starmap(process_frame, [(frame_num, video_full_file_name, exercises_dict, detector, predictor) for frame_num in range(video.get_length())])
